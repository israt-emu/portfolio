    ...
    >
      ...
      <div className="flex flex-col justify-center rounded-sm lg:text-left lg:w-3/5 sm:px-6 lg:px-0 mt-6 lg:mt-0">
        ...
        <div className="mt-6 mb-4 text-md sm:mb-8 text-small_text">
          Hello! My name is Israt Jahan Emu. I’ve completed my BSC and MSC from Noakhali Science & Technology University in <span className="text-title font-semibold font-mono">Applied Mathematics</span>.
          <br className="hidden lg:flex" />
          I’m fascinated by Mathematics and Programming. It excites me to solve mathematical problem and turn them into programming. Designing and developing websites is also a passion of mine since it is a part of programming. <br className="hidden lg:flex" />
          I’ve completed an internship at indian IT firm <span className="text-title font-semibold font-mono">Zivaka LLP</span> and built three professional websites with their team. And also have completed a 6 months job at KWS as a Full Stack developer.
