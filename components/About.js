...
const About = () => {
  ...
  return (
    <motion.div className="w-10/12 flex flex-col justify-center px-6 mx-auto sm:pt-14 pb-10 md:my-20 md:flex-row  items-center bg-slate-600/20 ring-1 ring-blue-400/20 rounded-2xl  backdrop-blur-sm" initial="offscreen" whileInView="onscreen" viewport={{once: true, amount: 0.1}} variants={aboutVariants}>
      <div className="flex items-center mt-8 lg:mt-0 w-1/2 relative ">
        ...
        <Image src={myImage} alt="" className="object-contain -top-6 left-5 lg:w-3/5 2xl:w-2/5 absolute rounded" />
      </div>
