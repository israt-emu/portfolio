    ...
    >
      ...
      <div className="grid grid-cols-5 gap-10 md:py-8">
        <div className="flex col-span-full md:col-span-1 md:flex-col md:justify-start md:items-start">
          <button
            className={`p-2 w-32 text-left border-b-2 md:border-l-2 md:border-b-0 md:py-3 overflow-x-auto md:overflow-hidden ${
              active === "programming"
                ? "border-primary text-primary skillbg"
                : "border-gray-500 text-gray-400"
            } hover:text-primary hover:bg-small_bg font-medium`}
            onClick={() => setActive("programming")}
          >
            Programming
          </button>
          <button
            className={`p-2 text-left w-32 border-b-2 md:border-l-2 md:border-b-0 md:py-3 ${
              active === "frontend"
                ? "border-primary text-primary skillbg"
                : "border-gray-500 text-gray-400"
            } hover:text-primary hover:bg-small_bg font-medium`}
